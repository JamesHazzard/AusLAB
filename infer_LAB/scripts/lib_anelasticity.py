...
class anelasticity_model(object):
   ...
   def compute_vs_vsu_anel_qual(self, depths, temps):
      ...
      #print(temps)
      #print(pres)
      #print(self.mu0, self.dmudT, self.dmudp)
      #print(np.min(unrlx_compl), np.max(unrlx_compl))
      #print(self.mu0 + (temps - 273)*self.dmudT)
      #print(temps[np.where((self.mu0 + (temps - 273)*self.dmudT) < 0)[0]])
      ...
      #print(np.min(period), np.max(period))
      #print(np.min(tau_maxwell), np.max(tau_maxwell))
      ...
      J_1 = unrlx_compl*(1+self.A_B*(period_non)**self.alpha_B/self.alpha_B\
               ...
               (1.-erf((np.log(self.tau_p)-np.log(period_non))/(np.sqrt(2)*sigma_p))))
      ...
      #print(np.isnan(period_non).any())
      #print(np.min(period_non), np.max(period_non))
      #print(unrlx_compl.dtype)
      #print(viscosity.dtype)
      #print(tau_maxwell)
      #print(period_non)
      #print(self.alpha_B)
      #print(self.tau_p)
